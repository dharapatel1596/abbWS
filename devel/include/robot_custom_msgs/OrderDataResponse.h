// Generated by gencpp from file robot_custom_msgs/OrderDataResponse.msg
// DO NOT EDIT!


#ifndef ROBOT_CUSTOM_MSGS_MESSAGE_ORDERDATARESPONSE_H
#define ROBOT_CUSTOM_MSGS_MESSAGE_ORDERDATARESPONSE_H
...
struct OrderDataResponse_
{
  typedef OrderDataResponse_<ContainerAllocator> Type;
  ...
  OrderDataResponse_(const ContainerAllocator& _alloc)
    : raw_id(0)
    , table_id(0)
    , order_time(_alloc)
    , target_pick_position_x(0.0)
  ...
  typedef boost::shared_ptr< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> const> ConstPtr;

}; // struct OrderDataResponse_

typedef ::robot_custom_msgs::OrderDataResponse_<std::allocator<void> > OrderDataResponse;

typedef boost::shared_ptr< ::robot_custom_msgs::OrderDataResponse > OrderDataResponsePtr;
typedef boost::shared_ptr< ::robot_custom_msgs::OrderDataResponse const> OrderDataResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator1> & lhs, const ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2d0e503dd50b9e8aULL;
  static const uint64_t static_value2 = 0xfd392ac3fc21b7afULL;
};

template<class ContainerAllocator>
struct DataType< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#output\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robot_custom_msgs::OrderDataResponse_<ContainerAllocator>& v)
  {
    s << indent << "raw_id: ";
...
#endif // ROBOT_CUSTOM_MSGS_MESSAGE_ORDERDATARESPONSE_H
