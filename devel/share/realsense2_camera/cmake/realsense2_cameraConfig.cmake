...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/dhara/arm_ws/src/realsense-ros/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/dhara/arm_ws/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /home/dhara/arm_ws/install)
...
if(NOT "/home/dhara/arm_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhara/arm_ws/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
...
set(depends "message_runtime;roscpp;sensor_msgs;std_msgs;rospy;nodelet;cv_bridge;image_transport;ddynamic_reconfigure;nav_msgs")
