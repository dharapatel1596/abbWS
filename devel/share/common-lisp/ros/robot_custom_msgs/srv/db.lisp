...
(cl:defmethod start-val ((m <db-request>))
...
(cl:defmethod raw_id-val ((m <db-response>))
...
(cl:defmethod table_id-val ((m <db-response>))
...
(cl:defmethod order_time-val ((m <db-response>))
...
(cl:defmethod validation_text-val ((m <db-response>))
