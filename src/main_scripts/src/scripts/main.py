...
class get_order_from_publisher(object):
    ...
    def reciving_order(self,sub_to):
        rospy.init_node('order_receiver', anonymous=True)
        rospy.loginfo('----Node started---ready to receive---')
    ...
    def callback(self,data):
            ...
            rospy.loginfo("Order received for table number: %s" %tableid)
...
if __name__ == '__main__':
    try:
        ...
        start.reciving_order(global_variables.robot_topic_name)
